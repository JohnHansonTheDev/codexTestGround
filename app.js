...
const TEAM_LOGOS = {
  ATL: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/atl.png', BOS: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/bos.png',
  BKN: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/bkn.png', CHA: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/cha.png',
  CHI: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/chi.png', CLE: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/cle.png',
  DAL: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/dal.png', DEN: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/den.png',
  DET: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/det.png', GSW: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/gs.png',
  HOU: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/hou.png', IND: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/ind.png',
  LAC: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/lac.png', LAL: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/lal.png',
  MEM: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/mem.png', MIA: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/mia.png',
  MIL: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/mil.png', MIN: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/min.png',
  NOP: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/no.png', NYK: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/ny.png',
  OKC: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/okc.png', ORL: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/orl.png',
  PHI: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/phi.png', PHX: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/phx.png',
  POR: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/por.png', SAC: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/sac.png',
  SAS: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/sa.png', TOR: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/tor.png',
  UTA: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/utah.png', WAS: 'https://a.espncdn.com/i/teamlogos/nba/500/scoreboard/wsh.png',
};

const statusLabel = { pre: 'Not Started', in: 'LIVE NOW', post: 'Final' };
...
const forceFiveStarsForBestTeams = (games) => {
  const ranked = games
    .flatMap((g) => [g.home, g.away])
    .sort((a, b) => b.strengthPct - a.strengthPct);
  const elite = new Set(ranked.slice(0, Math.min(6, ranked.length)).map((t) => t.short));

  return games.map((g) => ({
    ...g,
    home: {
      ...g.home,
      strength: `${elite.has(g.home.short) ? '★★★★★' : g.home.baseStars} (${g.home.strengthPct}%)`,
    },
    away: {
      ...g.away,
      strength: `${elite.has(g.away.short) ? '★★★★★' : g.away.baseStars} (${g.away.strengthPct}%)`,
    },
  }));
};
...
function mapEvent(event) {
  ...
  const leaders = (comp?.leaders || []).flatMap((l) => l.leaders || []).slice(0, 8).map((l) => ({
...
function GameCard({ game }) {
  return React.createElement('article', { className: 'game-card' },
    ...
    React.createElement('div', { className: 'intel-grid' },
      ...
      React.createElement('section', { className: 'intel' },
        ...
        React.createElement('p', null, `Game state: ${statusLabel[game.state] || game.state}`),
        React.createElement('p', null, `Detail: ${game.statusText}`),
      ),
    ),
  );
}

function RightPanel({ trendingPlayers, trendingTeams }) {
  return React.createElement('aside', { className: 'right-panel' },
    React.createElement('section', { className: 'side-card account' },
      React.createElement('h3', null, 'Your Account'),
      React.createElement('p', null, 'Unlock premium picks, alerts, and auto-tracked bet history.'),
      React.createElement('button', { type: 'button', className: 'google-btn' }, 'Continue with Google (Gmail)'),
      React.createElement('button', { type: 'button', className: 'email-btn' }, 'Login with Email'),
    ),
    React.createElement('section', { className: 'side-card' },
...
function App() {
  ...
  React.useEffect(() => {
    ...
    const load = async () => {
      try {
        ...
        setGames(forceFiveStarsForBestTeams(mapped));
        setError('');
      } catch (err) {
        if (!mounted) return;
  ...
  const focus = games.find((g) => g.state === 'in') || games[0];
  const trendingPlayers = games.flatMap((g) => g.leaders).slice(0, 7);
  const trendingTeams = games.flatMap((g) => [g.home, g.away]).sort((a, b) => parseWinPct(b.record) - parseWinPct(a.record)).slice(0, 7);
  ...
  return React.createElement(
    ...
    React.createElement('main', { className: 'app' },
      React.createElement('header', { className: 'hero' },
        ...
        React.createElement('h1', null, 'Clear Live Status, Real-Time Scores, and Premium Betting Intelligence'),
      ...
      React.createElement(LiveTicker, { games }),
        ...
        React.createElement('section', { className: 'content' },
          loading
            ...
            : React.createElement('section', { className: 'cards' },
              games.length ? games.map((g) => React.createElement(GameCard, { key: g.id, game: g })) : React.createElement('p', { className: 'loading' }, 'No games found for this feed window.'),
            ),
        ),
        React.createElement(RightPanel, { trendingPlayers, trendingTeams }),
      ),
    ),
  );
}
